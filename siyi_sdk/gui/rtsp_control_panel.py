...
project_dir = os.path.dirname(sdk_dir)
...
# If the gimbal moves in the wrong direction, flip these signs.
YAW_SIGN = 1
PITCH_SIGN = 1
...
class HumanTrackerApp:
    ...
    def update_video(self) -> None:
        ...
        if frame is not None:
            ...
            rgb_frame = display_frame #cv2.cvtColor(display_frame, cv2.COLOR_BGR2RGB)
